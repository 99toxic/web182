...
{
	$userQuery = "SELECT firstName, lastName, hourlyWage FROM personnel WHERE lastName ='King' OR lastname = 'Jones'"; // I changed lastname to 'King' and added OR lastname = 'Jones'
